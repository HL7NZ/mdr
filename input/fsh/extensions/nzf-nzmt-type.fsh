...
* ^url = "http://hl7.org.nz/fhir/StructureDefinition/nzmt-type"
* ^version = "0.1.0"
* ^status = #draft
...
* url = "http://hl7.org.nz/fhir/StructureDefinition/nzmt-type" (exactly)
* value[x] only CodeableConcept
* valueCodeableConcept 0..1
* valueCodeableConcept from $nzmt-type-vs (required)